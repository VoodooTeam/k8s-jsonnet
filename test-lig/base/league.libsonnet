...

{
  main(app_env, image, nrAppName, asset_config)::
    ...
    { deploy+: utils.deploy_container_merge(image, $.env_vars(app_env, nrAppName, asset_config)) } +  // inject env object to container definition
